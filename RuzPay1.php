...
ob_start();
define("uzfox","5054332460:AAGYPYXuGFIiu06B4cYiIH_zITMS_XyeWlQ");
$admin = "1903557761";
$botname = "RuzPayBot";
...
$status = $retus->result->status;
     ...
     uzfox("sendMessage",[
         "chat_id"=>$id,
         "text"=>"<b>✅Oldin quyidagi kanallarimizga obuna boʻling. Botni keyin toʻliq ishlatishingiz mumkin!</b>",
         "parse_mode"=>"html",
         "reply_to_message_id"=>$message_id,
"disable_web_page_preview"=>true,
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/RuzTv"],],
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/RuzPay"],],
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/Ruz_Apk"],],
...
$5000 = file_get_contents("uzfox/referal.sum");
...
uzfox("sendMessage",[
"chat_id"=>$referalid,
"text"=>"<b>👏 Tabriklaymiz! Sizni do'stingiz</b> <a href='tg://user?id=$fromid'>$firstname</a> <b>botimizdan ro'yxatdan o'tdi va sizga $5000 so'm taqdim etildi.</b>",
"parse_mode"=>"html",
"reply_markup"=>$menu,
]);
}
...
"chat_id"=>$fromid,
"text"=>"<b>🎊Quyidagi havolani doʻstlaringizga tarqatib pul ishlang. Ushbu manzil orqali kirgan har bir odam uchun sizga 5000 ming soʻmdan pul yutugʻi beriladi 🤑!</b> 👇",
"parse_mode"=>"html",
"reply_markup"=>$menu,
])->result->message_id;
uzfox("sendMessage",[
"chat_id"=>$fromid,
"text"=>"✅ <b>@RuzTv Kanalining rasmiy boti ✅🇺🇿</b> 🤖\n\n🎈 $username do'stingizdan unikal havola-taklifnoma.\n\n👇 Boshlash uchun bosing:\nhttps://t.me/$botname?start=$fromid",
"parse_mode"=>"html",
...
file_put_contents("uzfox/$chatid.contact","$phonenumber");
  ...
  uzfox("sendMessage",[
    "chat_id"=>$chatid,
    "text"=>"<b>❕Kechirasiz! Botdan faqat O'zbekiston fuqarolari foydalanishi mumkin yaʼni botimiz faqat Oʻzbekiston raqamlari uchun ishlaydi.</b>",
    "parse_mode"=>"html",
...
uzfox("sendPhoto",[
    "chat_id"=>$chatid,
"photo"=>"https://t.me/RuzPhp/4",
    "caption"=>"✅ <b>🎉 @RuzTV kanalining Rasmiy boti ✅</b> 🤖\n\n🎈 $username do'stingizdan unikal havola-taklifnoma.\n\n👇 Boshlash uchun bosing:
...
file_put_contents("uzfox/$chatid.textsum","$text");
       ...
       uzfox("sendMessage",[
           "chat_id"=>$chatid,
           "text"=>"⏰ So'rov yakunlandi!\nTo'lov 24 soat ichida amalga oshiriladi! Iltimos sabrli boʻling.\nTo'lov qilinganligi haqida sizga o'zimiz bot orqali xabar beramiz!",
"reply_markup"=>$menu,
]);
          uzfox("sendMessage",[
...
"parse_mode"=>"markdown",
       ...
       uzfox("sendMessage",[
              ...
              "parse_mode"=>"html",
               "reply_markup"=>json_encode([   
   "inline_keyboard"=>[
[["text"=>"👨‍💻 Admin","url"=>"https://t.me/RuzRek"],["text"=>"👥 Kanalimiz","url"=>"https://t.me/@RuzTV"],],
]
]),
]);
}
...
"disable_web_page_preview"=>true,
"parse_mode"=>"html",
"message_text"=>"✅ <b>🎉 @RuzTV kanalining Rasmiy boti ✅</b> 🤖\n\n🎈 $username do'stingizdan unikal havola-taklifnoma.\n\n👇 Boshlash uchun bosing:
...
uzfox("sendPhoto",[
"chat_id"=>$chatid,
"photo"=>"https://t.me/https://t.me/RuzPhp/3",
"caption"=>"<b>Savol - botda qanday qilib pul ishlash mumkin?</b>\n\n<b>Javob - botda pul ishlash juda oson, pul ishlash tugmasini bosing. Sizga berilgan unikal-havolani doʻstlaringizga yuboring. Doʻstingiz siz tarqatgan havola orqali botga kirib, bot bergan kanallarga a'zo bo‘lsa, biz sizning bot hisobingizga $5000 soʻm oʻtkazamiz.</b>\n\n<b>Qanday qilib pulni botdan chiqarish mumkin? Pullarni chiqarish to'g'ridan-to'g'ri sizning mobil telefoningizning hisobiga yoki kartangiz hisobiga amalga oshiriladi ✅:
...
uzfox("sendMessage",[
   "chat_id"=>$chatid,
   "text"=>"Nima haqida yozmoqchisiz? 😊\n\n<b>📞 Aloqa markazi:</b> @RuzRek",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"🗣 Bog'lanish","url"=>"https://t.me/RuzRek"],],
]
]),
]);
}
...
"chat_id"=>$chatid,
"photo"=>"https://t.me/RuzPhp/3",
"caption"=>"<b>Bot dasturchisi:</b> <a href='tg://user?id=1480667025'>uzfox</a>\n\n<b>Ish vaqti: 07:00 dan 23:00 gacha\n</b>",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"♻️ Bogʻlanish","url"=>"https://t.me/RuzRek"],],
]
]),
]);
}
